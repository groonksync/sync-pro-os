  ...
  const [form, setForm] = useState(() => {
    if (initialData) {
      return {
        ...
        pagos: [],
        ...initialData,
        inicio: initialData.inicio || new Date().toISOString().split('T')[0],
        fin: initialData.fin || (() => { const d = new Date(); d.setMonth(d.getMonth() + 6); return d.toISOString().split('T')[0]; })(),
        foto: initialData.foto || '',
        pagos: Array.isArray(initialData.pagos) ? initialData.pagos : [],
        tipo_pago: initialData.tipo_pago || 'mensual',
        plazo_meses: initialData.plazo_meses || 1,
        cuenta_bancaria: initialData.cuenta_bancaria || '',
        capital: initialData.capital?.toString() || '',
        interes: initialData.interes?.toString() || '5',
      };
    }
